<?php 
namespace Rsg\Enquiry\Model\Api; 
class TestApiManagement implements \Rsg\Enquiry\Api\TestApiManagementInterface
{
    ...
    public function __construct(
        \Rsg\Enquiry\Model\TestApiFactory $testApiFactory
