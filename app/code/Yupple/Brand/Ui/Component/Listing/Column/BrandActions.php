...
class BrandActions extends Column{
    /** Url path */
     const DEMO_URL_PATH_EDIT = 'yupple_brand/brandlist/edit';
     const DEMO_URL_PATH_DELETE = 'yupple_brand/brandlist/delete';
    /** @var UrlBuilder */
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['brand_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::DEMO_URL_PATH_DELETE, ['brand_id' => $item['brand_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
